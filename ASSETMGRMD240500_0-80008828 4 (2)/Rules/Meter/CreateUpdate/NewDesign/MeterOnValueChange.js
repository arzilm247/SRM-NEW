...
function updatePageControls(pageProxy, deviceData) {
    ...
    const divisionControl = CommonLibrary.getControlProxy(pageProxy, 'DivisionProp');
    ...
    if (!deviceData) {
        ...
        if (registerData) {
            ...
            if (registerData.Division_Nav) {
                let divisionNewValue = registerData.Division_Nav.Division + ' - ' + registerData.Division_Nav.Description;
                divisionControl.setValue(divisionNewValue);
            }
        }
