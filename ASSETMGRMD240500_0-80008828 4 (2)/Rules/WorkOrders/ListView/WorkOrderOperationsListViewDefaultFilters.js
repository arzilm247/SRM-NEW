...
export default async function WorkOrderOperationsListViewDefaultFilters(context) {
    ...
    filters.push(context.createFilterCriteria(context.filterTypeEnum.Sorter, 'OperationNo', undefined, ['OperationNo'], false, context.localizeText('sort_filter_prefix'), [context.localizeText('operation')]));
    return filters;
}
